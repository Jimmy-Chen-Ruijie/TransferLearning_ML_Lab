...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", nargs='+', help="paths to encoder and detector pretrained weights")  # cannot be left empty
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            detections = non_max_suppression(outputs, conf_thres=opt.conf_thres, nms_thres=opt.nms_thres)
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        plt.savefig(f"output/{filename}.png", bbox_inches="tight", pad_inches=0.0, dpi=200)
        plt.close()
